    ...
    return(
        <section id="home">
            <div className="intro">
                ...
                <a href='mailto: akanshasakhre@gmail.com' target="_blank" rel="noopener noreferrer"> <button className="hi-btn btn btn-outline-light"><i className="fa-solid fa-envelope fa-lg"></i> Say Hi!</button></a>
        </div>  
        </section>
    );
}
